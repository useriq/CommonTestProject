...
import main.java.*;
import main.java.page.CommonYotaPage;
import test.java.CommonWebTest;

import static com.codeborne.selenide.Selenide.open;
import static main.java.page.CommonYotaPage.URL_YOTA;
 ...
 */
public class CommonPageSteps extends CommonWebTest {
    ...
    public void isCommonYotaPageOpened() {
        ...
        assertTrue("Стартовая страница тестового приложения Yota успешно открыта", commonYotaPage.isThatIt());
        Log.screenshot();
